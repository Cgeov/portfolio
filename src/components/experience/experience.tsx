  ...
  return (
    <div className="bg-custom-gradient pt-36 pb-44 px-[5%]">
      ...
      <div className="relative pl-8 sm:pl-48 py-6 group">
        ...
        <div className="flex flex-col sm:flex-row items-start mb-1 group-last:before:hidden before:absolute before:left-2 before:border-l-[1px] before:border-dashed sm:before:left-0 before:h-full before:px-px  sm:before:ml-[10rem] before:self-start before:-translate-x-1/2 before:translate-y-3 after:absolute after:left-2 sm:after:left-0 after:w-2 after:h-2 after:bg-indigo-600 after:border-[1px] after:border-spacing-2 after:border-dashed after:box-content after:border-slate-50 after:rounded-full sm:after:ml-[10rem] after:-translate-x-1/2 after:translate-y-1.5">
          <time className="sm:absolute left-0 translate-y-0.5 inline-flex items-center justify-center text-xs font-semibold uppercase w-20 h-6 mb-3 sm:mb-0 text-emerald-600 bg-emerald-100 rounded-full">
            2023
          </time>
          <div className="text-xl font-bold text-slate-900">
