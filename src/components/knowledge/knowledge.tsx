...
export default function Knowlegde() {
  return (
    <div className="bgImageCode py-16">
          ...
          <ul className="mx-auto mt-12 grid max-w-md grid-cols-1 gap-10 sm:mt-16 lg:mt-20 lg:max-w-5xl lg:grid-cols-4">
            <li className="flex-start group relative flex lg:flex-col">
              <span
                ...
                aria-hidden="true"
              ></span>
              <div className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-gray-300 bg-gray-50 transition-all duration-200 group-hover:border-primary group-hover:bg-primary">
                <BsBackpack3Fill></BsBackpack3Fill>
                {/* <svg
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
              ...
              <div className="ml-6 lg:ml-0 lg:mt-10">
                ...
                <h4 className="mt-2 text-base text-white">
                  Bachillerato en Sistemas - Colegio Don Bosco
                </h4>
              </div>
            </li>
            <li className="flex-start group relative flex lg:flex-col">
              ...
              <div className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-gray-300 bg-gray-50 transition-all duration-200 group-hover:border-gray-900 group-hover:bg-gray-900">
                <GiDiploma className="h-5 w-5 text-gray-600 group-hover:text-white"></GiDiploma>
                {/* <svg
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
            ...
            <li className="flex-start group relative flex lg:flex-col">
              ...
              <div className="ml-6 lg:ml-0 lg:mt-10">
                ...
                <h4 className="mt-2 text-base text-white">
                  Curso React - Webcommservice
                </h4>
              </div>
            </li>
            <li className="flex-start group relative flex lg:flex-col">
              <div className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-gray-300 bg-gray-50 transition-all duration-200 group-hover:border-gray-900 group-hover:bg-gray-900">
                <FaGraduationCap className="h-5 w-5 text-gray-600 group-hover:text-white"></FaGraduationCap>
                {/* <svg
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
              ...
              <div className="ml-6 lg:ml-0 lg:mt-10">
                ...
                <h4 className="mt-2 text-base text-white">
                  Ingeniería en Ciencias de la computación - Universidad Don
                  Bosco
                </h4>
              </div>
            </li>
